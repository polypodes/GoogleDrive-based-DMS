                    ...
                    React.createElement("div", {className: "files-select-wrapper"}, 
                        React.createElement("select", {className: "files-select", ref: "select", id: "filetype", name: "filetype", onChange: this.handleSelectChange}, 
                            ...
                            this.state.fileType.map(function(item, index) {
                              return React.createElement("option", {value: item, key: index}, item);
                            })
                        )
                    ), 
...
module.exports = {
    ...
    'API_GET_FILES': '/api/files',
    'API_GET_LAST_FILES': '/api/lastmodified',
    'API_GET_FILES_TYPE': '/api/filetypes',
    'API_GET_FILES_BY_TYPE': '/api/files/type'
}
        ...
        return (
                React.createElement("section", null, 
                    ...
                    this.state.folders.map(function(folder) {
                        return React.createElement(FolderItemComponent, {key: folder.id, folder: folder});
                    }), 
...
var FolderItemComponent = React.createClass({displayName: "FolderItemComponent",
    ...
    render: function() {
        return (
            React.createElement("div", {key: this.props.key, className: "folder-item", onClick: this.handleClick}, this.props.folder.title)
            );
    }
});
...
},{"./FileActions":"/Users/alex/repo/GoogleDrive-based-DMS/integration/src/js/FileActions.js","nprogress":"/Users/alex/repo/GoogleDrive-based-DMS/integration/node_modules/nprogress/nprogress.js","react":"/Users/alex/repo/GoogleDrive-based-DMS/integration/node_modules/react/react.js"}],"/Users/alex/repo/GoogleDrive-based-DMS/integration/src/js/FolderStore.js":[function(require,module,exports){
var Reflux = require('reflux');
var FileActions = require('./FileActions');
var $ = require('zepto-browserify').$;
var CONST = require('./Constant');
                ...
                React.createElement("div", null, 
                    ...
                    React.createElement("ul", {className: "files"}, 
                        this.props.data.map(function(item) {
                          return React.createElement(ListRowComponent, {file: item, layout: this.props.layout, key: item.id});
                        }.bind(this))
                    )
                )
            );
